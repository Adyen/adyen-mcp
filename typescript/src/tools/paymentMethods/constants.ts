export const LIST_ALL_PAYMENT_METHODS_MERCHANT = "list_all_payment_methods_merchant";
...
export const GET_PAYMENT_METHODS_DETAILS_MERCHANT = "get_payment_methods_details_merchant";

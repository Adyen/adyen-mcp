...
import {
    ...
    GET_PAYMENT_METHODS_DETAILS_MERCHANT_DESCRIPTION, LIST_ALL_PAYMENT_METHODS_MERCHANT,
...
const listAllPaymentMethods = async (
    ...
    try {
        ...
        return "Failed to list payment methods on merchant account. Error: " + JSON.stringify(e);
    }
};
